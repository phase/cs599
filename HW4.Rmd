---
title: "HW4"
author: "YOUR NAME AND ID GO HERE"
date: "`r Sys.Date()`"
output:
...
for (x in 1:10) {
  ...
  page <- #read the page here
  quotes <- #get the div.quote elements
  quotes <- #convert the quotes from list to text (you may want to use text2)
